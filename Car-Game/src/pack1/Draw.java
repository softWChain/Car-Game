...
public class Draw extends JLabel {
	...
	protected void paintComponent(Graphics g) {
		...
		for (int i = 0; i < Var.enemY.length; i++) {
			switch (Var.r[i]) {
			case 1:
				g.fillRect(Var.x[0] - (Var.playerSize / 2), Var.enemY[i], Var.playerSize, Var.playerSize);
				break;
			case 2:
				g.fillRect(Var.x[1] - (Var.playerSize / 2), Var.enemY[i], Var.playerSize, Var.playerSize);
				break;
			case 3:
				g.fillRect(Var.x[2] - (Var.playerSize / 2), Var.enemY[i], Var.playerSize, Var.playerSize);
				break;
			}
		}
